    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 to-white">
        ...
        <div class="text-center max-w-4xl mx-auto">
          ...
          <div class="relative max-w-4xl mx-auto">
            <div class="bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden">
              <div class="bg-gray-50 border-b border-gray-200 p-4 flex items-center gap-2">
                <div class="flex gap-2">
                  <div class="w-3 h-3 rounded-full bg-red-400"></div>
                  <div class="w-3 h-3 rounded-full bg-yellow-400"></div>
                  <div class="w-3 h-3 rounded-full bg-green-400"></div>
                </div>
                <div class="text-sm text-gray-500 ml-4">Quick Add Interface</div>
              </div>
              <div class="p-8">
                <div class="mb-4">
                  <input 
      ...
      <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div class="text-center mb-16">
          <h2 class="text-3xl font-bold text-gray-900 mb-4">Built for speed and simplicity</h2>
          <p class="text-lg text-gray-600">Capture → Remind → Act. That's it.</p>
        </div>
      ...
      <section class="bg-gray-50 py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="grid md:grid-cols-3 gap-8 text-center">
            <div>
              <div class="text-4xl font-bold text-gray-900 mb-2">10s</div>
              <div class="text-gray-600">Average capture time</div>
            </div>
            <div>
              <div class="text-4xl font-bold text-gray-900 mb-2">99%</div>
              <div class="text-gray-600">Reminder delivery rate</div>
            </div>
            <div>
              <div class="text-4xl font-bold text-gray-900 mb-2">0</div>
              <div class="text-gray-600">Forgotten ideas</div>
            </div>
          </div>
        </div>
      </section>      
